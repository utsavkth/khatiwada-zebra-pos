...
const I18N = {
  en: {
    ...
    offlineNotFoundNoAdd: "Not found — new items need a connection to add",
    offlineBadge: "Offline — using saved catalog",
    saleSavedOffline: "Sale saved offline — ",
    pendingSyncOne: "1 sale waiting to sync",
    pendingSyncMany: " sales waiting to sync",
    langToggle: "नेपाली",
  ...
  ne: {
    ...
    offlineNotFoundNoAdd: "फेला परेन — नयाँ सामान थप्न इन्टरनेट चाहिन्छ",
    offlineBadge: "अफलाइन — सुरक्षित सूची प्रयोग हुँदै",
    saleSavedOffline: "बिक्री अफलाइन सुरक्षित — ",
    pendingSyncOne: "१ बिक्री सिंक हुन बाँकी",
    pendingSyncMany: " बिक्री सिंक हुन बाँकी",
    langToggle: "English",
